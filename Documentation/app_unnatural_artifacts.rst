...
A spike like this in your results indicates a discretization issue. In order to fix the issue you can increase the number of cells used in the simulation.
