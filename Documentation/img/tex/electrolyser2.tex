...
\begin{tikzpicture}
  \graph[layered layout, myedges, sibling distance = 0pt, sibling sep = 0pt, level distance = 1.5cm]
  { oer [as = \myobjnode{\mcodeclass{EvolutionElectrode}}]
    -> { oerptl [as = \myobjnode{\mcodeclass{PorousTransportLayer}}],
      oercatl [as = \myobjnode{\mcodeclass{CatalystLayer}}],
      oerexch [as = \myobjnode{\mcodeclass{ExchangeReactions}}]}};
\end{tikzpicture}
