...
\begin{tikzpicture}
  ...
  { 
    co [as = \myobjnode{2.8}{\mcode{Coating}\\ (\mcodeclass{ElectronicComponent})}] ->
    { am [as = \myobjnode{2.8}{\mcode{ActiveMaterial}}],
      bd [as = \myobjnode{2.8}{\mcode{Binder}}],
      ca [as = \myobjnode{2.8}{\mcode{ConductingAdditive}}]
    }
    };
\end{tikzpicture}
