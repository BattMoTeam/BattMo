            ...
            for indqp = 1 : model.nqp
                ...
                for isolute = 1 : model.nsolute
                    ...
                    if C(indqp, indsp) ~= 0
                        ...
                        qpDiffFluxes{indqp} = qpDiffFluxes{indqp} + assembleHomogeneousFlux(model, cs{indsp}, coef);
                    end
                end
            end
        ...
        function state = updateCurrent(model, state)
            ...
            for ind = 1 : nsolute
                ...
                if abs(species(indsp).z) > 0
                    ...
                    jchem = jchem + assembleHomogeneousFlux(model, cs{indsp}, jchemcoef);
                end
            end

            j = assembleHomogeneousFlux(model, phi, kappa) + jchem;
