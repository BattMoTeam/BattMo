%% Slider to understand better the impact of physical parameters 
% Loading the raw BattMo JSON parameter files for chemistry (Chen2020) and geometry.
...
%%
% Dynamically overriding the first observed parameter.
% Because ImpedanceExplore is a handle class, we can swap observed parameters 
% at runtime before starting the GUI. Here, we swap the negative electrode diffusion 
% coefficient with the positive electrode volumetric surface area.
