...
for i = 1:length(b)
    ...
    inputparams.NegativeElectrode.Coating.ActiveMaterial.Interface.reactionRateConstant = b(i);
    inputparams.PositiveElectrode.Coating.ActiveMaterial.Interface.reactionRateConstant = b(i)*5;
    ...
    Z_re = real(Z);
    Z_im = imag(Z);
    curve = sprintf('reactionRateConstant = %.2e', b(i));
