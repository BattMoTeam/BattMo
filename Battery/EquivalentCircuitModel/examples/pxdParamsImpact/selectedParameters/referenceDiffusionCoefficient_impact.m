...
for i = 1:length(b)
    ...
    inputparams.NegativeElectrode.Coating.ActiveMaterial.SolidDiffusion.referenceDiffusionCoefficient = b(i);
    inputparams.PositiveElectrode.Coating.ActiveMaterial.SolidDiffusion.referenceDiffusionCoefficient = b(i)/10;
    ...
    Z_re = real(Z);
    Z_im = imag(Z);
    curve = sprintf('Diffusion Coefficient = %.2e', b(i));
