...
b = logspace(-15, -10, 20);                        %change here
...
for i = 1:length(b)
    ...
    inputparams.NegativeElectrode.Coating.ActiveMaterial.SolidDiffusion.referenceDiffusionCoefficient = b(i);          %change here
    inputparams.PositiveElectrode.Coating.ActiveMaterial.SolidDiffusion.referenceDiffusionCoefficient = b(i)/10;          %change here
    ...
    Z_re = real(Z);
    Z_im = imag(Z);
    curve = sprintf('Diffusion Coefficient = %.2e', b(i));  %change here
