...
for i = 1:length(b)
    ...
    inputparams.NegativeElectrode.Coating.volumeFraction = b(i);
    inputparams.PositiveElectrode.Coating.volumeFraction = b(i);
    ...
    Z_re = real(Z);
    Z_im = imag(Z);
    curve = sprintf('Volume Fraction = %.2f', b(i));
