classdef lithiumIon < handle
    ...
    methods
        function obj = lithiumIon(varargin)
        ...
        function dynamicReadState(obj, y, yp, varargin)
            ...
            j = harm(sigmaeff, X, Xb) .* (-1) .* grad(phi, X, 'right', 'dirichlet', obj.ccpe.E);
        ...
        function dynamicBuildSOE(obj, t, varargin)
            ...
            obj.elyte.sp.Li.massCons = ( - obj.elyte.sp.Li.divDiff ...
