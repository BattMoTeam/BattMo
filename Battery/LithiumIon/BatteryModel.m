classdef BatteryModel < CompositeModel
    ...
    methods
        ...
        function model = BatteryModel(varargin)
            ...
            fnmodel = {'..'};
            ne    = ne.addPropFunction('massCons', fnupdate, inputnames, fnmodel);
            pe    = pe.addPropFunction('massCons', fnupdate, inputnames, fnmodel);
            elyte = elyte.addPropFunction('massCons', fnupdate, inputnames, fnmodel);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
