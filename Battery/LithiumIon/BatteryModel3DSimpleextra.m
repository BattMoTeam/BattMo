classdef BatteryModel3DSimpleextra < BatteryModelSimple
    ...
    methods
        ...
        function model = setupBatteryComponents(model)
            ...
            model.elyte = orgLiPF6('elyte'       , G, elytecells);
            model.ne = graphiteElectrode('ne' , G, necells);
            model.pe = nmc111Electrode('pe'   , G, pecells);
            model.ccne = currentCollector('ccne', G, ccnecells);
            model.ccpe = currentCollector('ccpe', G, ccpecells);
            model.sep = celgard2500('sep'      , G, sepcells);
