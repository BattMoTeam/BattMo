classdef lithiumIonModel < handle
    ...
    methods
        ...
        function dynamicBuildSOE(obj, t, y, yp, varargin)
            ...
            obj.elyte.sp.Li.massCons = ( - obj.elyte.sp.Li.divDiff - obj.elyte.sp.Li.divMig + obj.elyte.sp.Li.source ...
                                         - obj.elyte.sp.Li.cepsdot);

            %% Liquid electrolyte charge continuity %%%%%%%%%%%%%%%%%%%%%%%

            obj.elyte.chargeCons = -(obj.elyte.operators.Div( obj.elyte.j)./obj.elyte.Grid.cells.volumes) ./ obj.con.F+ ...
                obj.elyte.sp.Li.source .* obj.elyte.sp.Li.z;

            %% Active material mass continuity %%%%%%%%%%%%%%%%%%%%%%%%%%%
            obj.ne.am.Li.massCons = (-obj.ne.am.Li.divDiff + obj.ne.am.Li.source - obj.ne.am.Li.csepsdot);
            obj.pe.am.Li.massCons = (-obj.pe.am.Li.divDiff + obj.pe.am.Li.source - obj.pe.am.Li.csepsdot);

            %% Active material charge continuity %%%%%%%%%%%%%%%%%%%%%%%%%%%

            obj.ne.am.e.chargeCons = (obj.ne.operators.Div(obj.ne.j) - obj.ne.j_bcsource)./ ...
                obj.ne.Grid.cells.volumes./obj.con.F - obj.ne.am.e.source;
            obj.pe.am.e.chargeCons = (obj.pe.operators.Div(obj.pe.j) - obj.pe.j_bcsource)./ ...
                obj.pe.Grid.cells.volumes./obj.con.F - obj.pe.am.e.source;

            obj.ccne.am.e.chargeCons = (obj.ccne.operators.Div(obj.ccne.j) - obj.ccne.j_bcsource)./ ...
                obj.ccne.Grid.cells.volumes./obj.con.F;
            obj.ccpe.am.e.chargeCons = (obj.ccpe.operators.Div(obj.ccpe.j) - obj.ccpe.j_bcsource)./ ...
            ...
            %% State vector %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            obj.soe = vertcat(obj.elyte.sp.Li.massCons, ...
                              obj.elyte.chargeCons    , ...
                              obj.ne.am.Li.massCons   , ...
                              obj.ne.am.e.chargeCons  , ...
                              obj.pe.am.Li.massCons   , ...
