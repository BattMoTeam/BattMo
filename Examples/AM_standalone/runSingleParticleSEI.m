...
if dograph
    ...
    % [g, edgelabels] = cgit.setupGraph('oneParentOnly', true, 'type', 'ascendant');
    % [g, edgelabels] = cgit.setupGraph('oneParentOnly', true, 'type', 'descendant');
    % [g, edgelabels] = cgit.setupGraph();
    [g, edgelabels] = cgit.setupDescendantGraph();
    figure
