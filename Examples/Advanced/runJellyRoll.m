...
if testing
    ...
    %%
    % We do not include any special tab so that the whole current collector at the top and bottom is connected to the
    % external system (tabless design).
