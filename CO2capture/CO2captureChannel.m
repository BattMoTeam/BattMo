classdef CO2captureChannel < BaseModel
    ...
    methods
        ...
        function model = CO2captureChannel(inputparams)
        ...
        function model = registerVarAndPropfuncNames(model)
            ...
            for igas = 1 : nGas
                ...
                fn = @CO2captureChannel.updatePressures;
                inputvarnames = {'pressure', VarName({}, 'molFractions', nGas, igas)};
                ...
                if model.isRootSimulationModel
                    ...
                    fn = @CO2captureChannel.updateMassSources;
