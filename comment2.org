...
* electronic conductivity
  - should not be property of active material as can be seen [[file:Electrochemistry/ElectrodeActiveComponent.m::econd = model.ActiveMaterial.electronicConductivity;][here]] but of ElectrodeActiveComponent
* heat capacity
  - in [J][K]^-1[m]^-3
