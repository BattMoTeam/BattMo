classdef RestControlModel < ControlModel
    
    methods

        function model = RestControlModel(inputparams)

            model = model@ControlModel(inputparams);

            model.controlPolicy = 'rest';
        ...
        function model = registerVarAndPropfuncNames(model)
            ...
            model = model.registerVarName('ctrlType');
