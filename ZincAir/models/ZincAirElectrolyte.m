classdef ZincAirElectrolyte < ElectronicComponent
    ...
    methods
        ...
        function model = registerVarAndPropfuncNames(model)
            ...
            fn = @() ZincAirElectrolyte.updateAtomicMassCons;
            for inqp = 1 : nqp
            ...
            fn = @() ZincAirElectrolyte.updateMassCons;
            for inqp = 1 : nqp
            ...
            fn = @() ZincAirElectrolyte.updateElectrolyteAccumTerms;
            ...
            % fn = @() ZincAirElectrolyte.computeLiquidQuasiParticleConcentration;
