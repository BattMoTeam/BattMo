classdef ZincAirBattery < BaseModel
    ...
    properties
        ...
        %% Helper properties (setup at instantiation)
    ...
    methods
        ...
        function model = ZincAirBattery(inputparams)
            ...
            % Setup Cathode
            model.Cathode = OxygenElectrode(inputparams.Cathode);
        ...
        function model = setupAnode(model, inputparams)
            ...
            model.Anode = ZincElectrode(inputparams);
        ...
        function model = registerVarAndPropfuncNames(model)
            ...
            if model.include_precipitation
                nqp = model.(elyte).nqp;
                fn = @() ZincAirBattery.updateElectrolyteVolumeFractionEquation;
            ...
            fn = @() ZincAirBattery.dispatchTemperature;
            inputnames = {'T'};
            ...
            fn = @() ZincAirBattery.updateCathodeActiveMaterialConcentration;
            ...
            fn = @() ZincAirBattery.updateCathodeActiveMaterialPotentials;
            inputnames = {{ct, 'phi'}, ...
                          {elyte, 'phi'}};
            ...
            fn = @() ZincAirBattery.updateAnodeActiveMaterialConcentration;
            inputnames = {VarName({elyte}, 'cs', nsp, spdict('H+'))};
            model = model.registerPropFunction({{anam, 'cElectrolyte'}, fn, inputnames});
            
            fn = @() ZincAirBattery.updateAnodeActiveMaterialPotentials;
            inputnames = {{an, 'phi'}            , ...
                          {an, 'volumeFraction'} , ...
                          {elyte, 'phi'}};
            ...
            fn = @() ZincAirBattery.updateAnodeSource;
            inputnames = {{anam, 'R'}};
            model = model.registerPropFunction({{an, 'sourceTerm'}, fn, inputnames});
            
            % fn = @() ZincAirBattery.updateAnodeBcSource; 
            ...
            % nqp = model.(elyte).nqp;
            % fn = @() ZincAirBattery.updateQuasiParticleSource;
            % inputnames = {{ctam, 'R'} , ...
            %               {anam, 'R'}   , ...
            ...
            fn = @() ZincAirBattery.updateElectrolyteCurrentSource;
            inputnames = {{ctam, 'R'}, ...
                          {anam, 'R'}};
            model = model.registerPropFunction({{elyte, 'eSource'}, fn, inputnames});

            fn = @() ZincAirBattery.updateCathodeSource;
