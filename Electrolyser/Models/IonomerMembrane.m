classdef IonomerMembrane < ElectronicComponent
    ...
    methods
        ...
        function state = updatejchem(model, state)
            ...
            state.jchem = assembleHomogeneousFlux(model, cH2O, fluxcoef);
        ...
        function state = updateCurrent(model, state)
            ...
            jelec = assembleHomogeneousFlux(model, phi, kappaeff);
        ...
        function state = updateH2OdiffFlux(model, state)
            ...
            state.H2OdiffFlux = assembleHomogeneousFlux(model, c, Deff);
