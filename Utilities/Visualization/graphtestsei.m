...
if dograph
    ...
    % cgti.includeNodeNames = 'cSurface';
    cgti.includeNodeNames = 'phiElectrolyte';
    % gg = cgti.setupDescendantGraph();
    % gg = cgti.getComputationalGraph('oneParentOnly', true);    
